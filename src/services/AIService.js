...
const { findOilsByKeywords, getAllOils } = require('../data/full_oils_database');
  ...
  async getBasicRecommendation(routingResult) {
    try {
      ...
      const fallbackRecommendations = {
        ...
        'головная_боль': '🤕 **От головной боли рекомендую:**\n\n🌿 **Мята перечная + Лаванда**\n💡 **Применение:**\n• **Массаж висков:** 1 капля мяты + 1 капля лаванды + 10 мл базового масла\n• **Ингаляция:** 2 капли мяты в горячую воду\n• **Компресс:** 3 капли смеси на холодный компресс\n\n⚡ **Быстрый рецепт:**\n- Мята перечная: 2 капли\n- Лаванда: 1 капля\n- Базовое масло: 15 мл\n- **Применение:** Массаж висков и шеи\n\n⚠️ **Безопасность:**\n- Избегать попадания в глаза\n- Не использовать при беременности\n- При сильной боли обратиться к врачу',
        'простуда': '🤧 **При простуде рекомендую:**\n\n🌿 **Эвкалипт + Чайное дерево**\n💡 **Применение:**\n• **Ингаляция:** 3 капли эвкалипта в горячую воду\n• **Растирание груди:** 2 капли эвкалипта + 2 капли чайного дерева + 20 мл базового масла\n• **Аромалампа:** 4-5 капель смеси\n\n⚡ **Быстрый рецепт:**\n- Эвкалипт: 3 капли\n- Чайное дерево: 2 капли\n- Базовое масло: 20 мл\n- **Применение:** Растирание груди и спины\n\n⚠️ **Безопасность:**\n- Не использовать при астме\n- Избегать попадания в глаза\n- При высокой температуре обратиться к врачу',
        'стресс': '😰 **От стресса рекомендую:**\n\n🌿 **Лаванда + Бергамот**\n💡 **Применение:**\n• **Аромалампа:** 3 капли лаванды + 2 капли бергамота\n• **Ванна:** 5 капель смеси + соль для ванны\n• **Массаж:** 3 капли смеси + 20 мл базового масла\n\n⚡ **Быстрый рецепт:**\n- Лаванда: 2 капли\n- Бергамот: 1 капля\n- Базовое масло: 15 мл\n- **Применение:** Массаж плеч и шеи\n\n⚠️ **Безопасность:**\n- Бергамот фототоксичен - избегать солнца\n- Тест на аллергию обязателен\n- Не использовать при беременности',
      ...
      const fallbackKeyword = keywords?.[0] || 'спокойствие';
      const recommendation = fallbackRecommendations[fallbackKeyword] || fallbackRecommendations['спокойствие'];
